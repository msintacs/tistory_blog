...
const Footer = () => {
  return (
    <footer className="border-t border-gray-200 bg-gray-50 pt-12 pb-8">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mb-4 max-w-md text-gray-600">
              개발자를 위한 기술 블로그입니다. 최신 웹 개발 트렌드와 유용한 팁을
              공유합니다. 함께 성장하는 개발 커뮤니티를 만들어 갑니다.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-200 text-gray-600 transition-colors hover:bg-blue-500 hover:text-white"
                aria-label="GitHub"
              >
                <svg
                  className="h-5 w-5"
              ...
              <a
                href="#"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-200 text-gray-600 transition-colors hover:bg-blue-400 hover:text-white"
                aria-label="Twitter"
              >
                <svg
                  className="h-5 w-5"
        ...
        <div className="mt-8 flex flex-col border-t border-gray-200 pt-8 md:flex-row md:items-center md:justify-between">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} DevArchive Blog. All rights reserved.
          </p>
